...
const cowModel_1 = require("./cowModel");
...
const createCow = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createCow = (yield cowModel_1.Cow.create(payload)).populate("seller");
    if (!createCow) {
...
const getAllCows = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            $or: cowConstant_1.cowSearchableFields.map((field) => ({
                [field]: {
                    $regex: searchTerm,
                    $options: "i",
                },
    ...
    const result = yield cowModel_1.Cow.find(whereConditions)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
    const total = yield cowModel_1.Cow.countDocuments(whereConditions);
    return {
        meta: {
            page,
            limit,
...
const getSingleCow = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cowModel_1.Cow.findById(id);
    return result;
});
const updateCow = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cowModel_1.Cow.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteCow = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cowModel_1.Cow.findByIdAndDelete({ _id: id });
    if (result) {
        return result;
    }
    else {
